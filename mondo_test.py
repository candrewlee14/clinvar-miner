...
class MondoTestCases(unittest.TestCase):
    ...
    def test_matches(self):
        ...
        self.assertEqual(mon.matches('blank', list1), set(['MONDO:0007038','MONDO:0007139', 'MONDO:0001976', 'MONDO:0001595']))
        list2 = list(map(
                lambda mondo_xref: mondo_xref_to_xref[mondo_xref],
                ['MONDO:0007038','MONDO:0007139', 'MONDO:0001595']
                ))
        self.assertEqual(mon.matches('chorea gravidarum', list2), set(['MONDO:0007038','MONDO:0007139', 'MONDO:0001976', 'MONDO:0001595', 'MONDO:0001976']))
...
# BLANK CONDITION NAMES
    def test_most_specific_matches_blank_name_single_ancestor(self):
        ...
        mons = mon.most_specific_matches(
            'blank', 
            xrefs
        )
    ...
    def test_least_specific_matches_blank_name_one_descendent(self):
        #test 1, 1 descendent
        xrefs = list(map(
                lambda mondo_xref: mondo_xref_to_xref[mondo_xref],
                ['MONDO:0007038','MONDO:0007139', 'MONDO:0001976', 'MONDO:0001595']
                ))
        mons = mon.least_specific_matches(
            'blank', 
            xrefs
        )        
        self.assertEqual(mons, set(['MONDO:0007038','MONDO:0007139', 'MONDO:0001595']))

    def test_least_specific_matches_blank_name_all_direct_descendents(self):
        ...
        self.assertEqual(mons, set(['MONDO:0001595']))

    def test_least_specific_matches_blank_name_all_descendents(self):
        ...
        self.assertEqual(mons, set(['MONDO:0005395']))
    ...
    def test_least_specific_matches_one_descendent(self):
        #test 1, 1 descendent
        xrefs = list(map(
                lambda mondo_xref: mondo_xref_to_xref[mondo_xref],
                ['MONDO:0007038', 'MONDO:0001976', 'MONDO:0001595']
                ))
        mons = mon.least_specific_matches(
    ...
    def test_least_specific_matches_all_direct_descendents(self):
        #test 2, all direct descendents
        #Ancestor: MONDO:0001595
        xrefs = list(map(
                lambda mondo_xref: mondo_xref_to_xref[mondo_xref],
                ['MONDO:0001976', 'MONDO:0007325', 'MONDO:0008979']
                ))
        mons = mon.least_specific_matches(
            'choreatic disease', 
            xrefs
    ...
    def test_least_specific_matches_all_descendents(self):
        #test 3, all descendents (1 - 2 levels down)
        #Ancestor: MONDO:0003847
        xrefs = list(map(
                lambda mondo_xref: mondo_xref_to_xref[mondo_xref],
    ...
    def test_lowest_common_ancestor(self):
        #direct children
        self.assertEqual('MONDO:0001214', mon.lowest_common_ancestor(['MONDO:0001224', 'MONDO:0001226', 'MONDO:0005634'])) 
        #multiple children and indirect ancestors
        self.assertEqual('MONDO:0020683', mon.lowest_common_ancestor(['MONDO:0001224', 'MONDO:0001226', 'MONDO:0005634', 'MONDO:0001817'])) 
        #common ancestor in list
        self.assertEqual('MONDO:0001214', mon.lowest_common_ancestor(['MONDO:0001224','MONDO:0001214'])) 
        #offset deep children
        self.assertEqual('MONDO:0000001', mon.lowest_common_ancestor(['MONDO:0043079','MONDO:0027751'])) 

    def test_lowest_common_ancestor_extras(self):
        string = 'HP:0001263;HP:0001270;HP:0001344;HP:0002126;HP:0002194;HP:0002273;HP:0002518;HP:0007204;HP:0008936;HP:0009062;HP:0100021;MONDO:0000087;MONDO:0006497;UMLS:C0007789;UMLS:C0266464;UMLS:C0270790;UMLS:C0557874;UMLS:C1837658;UMLS:C1853743;UMLS:C1854301;UMLS:C1854882;UMLS:C2673431;UMLS:C3806604;UMLS:C4024923'
        self.assertEqual('MONDO:0002602', mon.lowest_common_ancestor(string.split(';')))
    
    def test_lowest_common_ancestor_extras2(self):
        string = 'MONDO:0008810;OMIM:207750;OMIM:608083.0002;OMIM:608083.0003;OMIM:608083.0004;OMIM:608083.0005;OMIM:608083.0006;OMIM:608083.0007;OMIM:608083.0008;OMIM:608083.0011;OMIM:608083.0012;ORPHANET:444490;UMLS:C1720779'
        self.assertEqual('MONDO:0008810', mon.lowest_common_ancestor(string.split(';')))
