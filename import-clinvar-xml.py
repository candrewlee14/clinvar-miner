...
def get_submissions(date, set_xml):
    ...
    condition_mondo_xref = mondo.lowest_common_ancestor(mondo_xrefs)
...
def import_file(filename):
    ...
    cursor.execute('''
        ...
        ON t1.date=? AND t2.date=? AND t1.variant_name=t2.variant_name AND t1.condition_mondo_xref=t2.condition_mondo_xref
